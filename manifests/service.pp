...
define nagioscfg::service(ensure = 'present', $hostgroup_name = undef, $host_name = undef, description = undef, check_command = undef, use = undef, contact_groups = undef, notes = undef) {
